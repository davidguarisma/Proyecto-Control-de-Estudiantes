...
//Variable que recibe el nombre que tendra el respaldo//
$campos= "Respaldo_".date("Y-m-d_g:i:s").".sql";
...
$info['mysqlver'] =  $mysqli->get_server_info();
    ...
    while ($fila =  $respuesta->fetch_array()) {
            ...
            foreach ($columnas as $columna) {
                if ( gettype($fila[$columna]) == "NULL" ) {
                    ...
                    $values[] = "'". $mysqli->real_escape_string($fila[$columna])."'";
                }
            }
